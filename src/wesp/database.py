...
class Database:
    ...
    format of CLIENT_DATA inside the :mod:`cli_parser` module.
    """
    ...
    registered Parameter in :class:`wesp.definitions.AllParameter`) will be inserted in the :meth:`init_database` 
    ...
    inserted in the function :meth:`init_database`. The generation of that data is done in 
    ...
    def init_database(ctx, config, parameter_create, parameter_insert):
        ...
        :param parameter_create: parameter part of create statement, can be generated by :meth:`wesp.helper.generate_parameter_create_statement`
        :param parameter_insert: parameter part of insert statement, can be generated by :meth:`wesp.helper.generate_parameter_insert_statement`
    ...
    def create_database_and_table_if_not_existing(config):
        ...
        """
        Will check the existence of the database and the table with the names specified in the :meth:`init_database`
    ...
    def insert_data_set(data_set, ctx, time):
        ...
        :param data_set: data_set to be inserted, must contain the same fields name as defined in the *insertStatement*
        :param ctx: current Context
